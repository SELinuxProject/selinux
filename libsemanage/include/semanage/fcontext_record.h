...
/* Regexp */
extern const char *
semanage_fcontext_get_expr(const semanage_fcontext_t *fcontext);
...
extern void semanage_fcontext_set_type(semanage_fcontext_t *fcontext, int type);
