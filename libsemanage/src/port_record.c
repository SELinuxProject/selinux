...
int semanage_port_key_create(semanage_handle_t *handle, int low, int high,
			     int proto, semanage_port_key_t **key_ptr)
{
...
int semanage_port_set_con(semanage_handle_t *handle, semanage_port_t *port,
...
int semanage_port_create(semanage_handle_t *handle, semanage_port_t **port_ptr)
{
	return sepol_port_create(handle->sepolh, port_ptr);
}

int semanage_port_clone(semanage_handle_t *handle, const semanage_port_t *port,
