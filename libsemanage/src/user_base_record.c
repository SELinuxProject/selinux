...
/* Name */
const char *semanage_user_base_get_name(const semanage_user_base_t *user)
{
	return sepol_user_get_name(user);
}

int semanage_user_base_set_name(semanage_handle_t *handle,
				semanage_user_base_t *user, const char *name)
{
	return sepol_user_set_name(handle->sepolh, user, name);
}

/* MLS */
const char *semanage_user_base_get_mlslevel(const semanage_user_base_t *user)
{
...
const char *semanage_user_base_get_mlsrange(const semanage_user_base_t *user)
{
...
int semanage_user_base_add_role(semanage_handle_t *handle,
				semanage_user_base_t *user, const char *role)
{
	return sepol_user_add_role(handle->sepolh, user, role);
}

void semanage_user_base_del_role(semanage_user_base_t *user, const char *role)
{
