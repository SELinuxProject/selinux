...
int semanage_node_key_create(semanage_handle_t *handle, const char *addr,
...
int semanage_node_set_addr(semanage_handle_t *handle, semanage_node_t *node,
...
int semanage_node_set_addr_bytes(semanage_handle_t *handle,
				 semanage_node_t *node, const char *addr,
				 size_t addr_sz)
{
...
int semanage_node_set_mask(semanage_handle_t *handle, semanage_node_t *node,
...
int semanage_node_set_mask_bytes(semanage_handle_t *handle,
				 semanage_node_t *node, const char *mask,
				 size_t mask_sz)
{
...
int semanage_node_set_con(semanage_handle_t *handle, semanage_node_t *node,
...
int semanage_node_create(semanage_handle_t *handle, semanage_node_t **node_ptr)
{
	return sepol_node_create(handle->sepolh, node_ptr);
}

int semanage_node_clone(semanage_handle_t *handle, const semanage_node_t *node,
