...
{
	return sepol_ibpkey_key_create(handle->sepolh, subnet_prefix, low, high,
				       key_ptr);
}
...
{
	return sepol_ibpkey_get_subnet_prefix(handle->sepolh, ibpkey,
					      subnet_prefix_ptr);
}
...
{
	return sepol_ibpkey_set_subnet_prefix(handle->sepolh, ibpkey,
					      subnet_prefix);
}
