...
static inline unsigned int ebitmap_start(const ebitmap_t *e, ebitmap_node_t **n)
{
	*n = e->node;
...
static inline int ebitmap_node_get_bit(const ebitmap_node_t *n,
				       unsigned int bit)
{
...
extern int ebitmap_and(ebitmap_t *dst, const ebitmap_t *e1,
		       const ebitmap_t *e2);
extern int ebitmap_xor(ebitmap_t *dst, const ebitmap_t *e1,
		       const ebitmap_t *e2);
extern int ebitmap_not(ebitmap_t *dst, const ebitmap_t *e1,
		       unsigned int maxbit);
extern int ebitmap_andnot(ebitmap_t *dst, const ebitmap_t *e1,
			  const ebitmap_t *e2, unsigned int maxbit);
...
extern int ebitmap_init_range(ebitmap_t *e, unsigned int minbit,
			      unsigned int maxbit);
