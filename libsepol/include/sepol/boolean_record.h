...
/* Key */
extern int sepol_bool_key_create(sepol_handle_t *handle, const char *name,
...
extern int sepol_bool_set_name(sepol_handle_t *handle, sepol_bool_t *boolean,
			       const char *name);
...
extern int sepol_bool_clone(sepol_handle_t *handle, const sepol_bool_t *boolean,
