...
extern int sepol_port_key_create(sepol_handle_t *handle, int low, int high,
				 int proto, sepol_port_key_t **key_ptr);

extern void sepol_port_key_unpack(const sepol_port_key_t *key, int *low,
				  int *high, int *proto);
...
extern int sepol_port_clone(sepol_handle_t *handle, const sepol_port_t *port,
