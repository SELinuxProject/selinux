 ...
 */
extern void sepol_policy_file_set_mem(sepol_policy_file_t *pf, char *data,
				      size_t len);
 ...
 */
extern int sepol_policydb_from_image(sepol_handle_t *handle, void *data,
				     size_t len, sepol_policydb_t *p);
 ...
 */
extern int sepol_policydb_to_image(sepol_handle_t *handle, sepol_policydb_t *p,
