 ...
 */
extern void test_sym_presence(policydb_t *p, const char *id, int sym_type,
 ...
 */
extern void test_alias_datum(policydb_t *p, const char *id,
			     const char *primary_id, char mode,
			     unsigned int flavor);
 ...
 */
extern role_datum_t *test_role_type_set(policydb_t *p, const char *id,
 ...
 * avrule decl block matches our expectations 
 */
extern void test_attr_types(policydb_t *p, const char *id, avrule_decl_t *decl,
